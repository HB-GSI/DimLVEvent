...
INFO2SF</Property>
	...
	<Item Name="supportFiles" Type="Folder">
		...
		<Item Name="DimSPL.dll" Type="Document" URL="../../bin/DimSPL.dll"/>
		<Item Name="DimStd.dll" Type="Document" URL="../../bin/DimStd.dll"/>
